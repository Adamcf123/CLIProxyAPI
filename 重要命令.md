...
curl -H 'Authorization: Bearer adamcf' \
  'http://localhost:53355/v0/management/tps?window=6m&provider=fox&model=gpt-5-medium'

curl -H 'Authorization: Bearer adamcf' \
  'http://localhost:53355/v0/management/tps?window=6m&provider=codex&model=gpt-5-codex-medium'
curl -H 'Authorization: Bearer adamcf' \
  'http://localhost:53355/v0/management/tps?window=6m&provider=fox&model=gpt-5-codex-medium'
